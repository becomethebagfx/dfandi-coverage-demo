...
- [x] C34: Wiring audit: em-dash sweep clean, `npm run build` passes, every route 200 OK on the deployed URL.
- [x] C35: Take screenshots at the 3 viewports for each of the 8 routes (24 total) into `screenshots/v2/`.
- [x] C36: Update engagement memory + dfandi-ai/CONTINUITY.md with the new URL state + pivot note.
- [x] C37: Mark DONE = true.
